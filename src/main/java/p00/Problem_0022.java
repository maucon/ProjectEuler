...
public class Problem_0022 {
    ...
    private static ArrayList<String> readNames() {
        ...
        try {
            BufferedReader br = new BufferedReader(new InputStreamReader(new URL("https://projecteuler.net/project/resources/p022_names.txt").openConnection().getInputStream()));
